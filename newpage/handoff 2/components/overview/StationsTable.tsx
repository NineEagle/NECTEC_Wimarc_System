...
export function StationsTable({
  ...
  const th = "sticky top-0 z-[1] cursor-pointer select-none whitespace-nowrap border-b bg-background px-2.5 py-2.5 text-[11px] font-semibold text-muted-foreground"
              ...
              return (
                ...
                >
                  ...
                  <td className="px-2.5 py-2.5">
                    <div className="whitespace-nowrap text-[13px] font-semibold">{s.name}</div>
                    <div className="font-mono text-[10.5px] text-muted-foreground">{s.id} · {s.province}</div>
                  </td>
                  {HEADLINE.map((h) => {
                    ...
                    return (
                      <td key={h.key} className="px-2.5 py-2.5 text-right">
                        <span className={`text-[13px] font-semibold tabular-nums ${off ? "text-muted-foreground" : alert ? "text-orange-600" : "text-foreground"}`}>
                  ...
                  <td className="px-2.5 py-2.5 text-right">
                    <span className="text-[13px] font-semibold tabular-nums text-sensor-soil-fg">
