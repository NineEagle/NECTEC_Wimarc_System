...
export default function DailyAveragesPage() {
  ...
  const chartData = aggregates.map((agg) => ({
    ...agg,
    dateLabel: (() => {
      const d = new Date(agg.date as any);
      ...
      <div className="flex items-end justify-between border-b pb-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight flex items-center gap-2">
            ค่าเฉลี่ยรายวัน
            {/* <span className="text-[10px] font-mono bg-muted px-1.5 py-0.5 rounded text-muted-foreground uppercase">TOR 4.5.5</span> */}
          </h1>
        ...
        <>
          ...
          <div className="bg-muted/50 rounded-lg p-3 flex items-center justify-between flex-wrap gap-3 border shadow-sm text-sm">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Select
                value={sensorType}
                onValueChange={(v) => setSensorType(v as "main" | "client")}
              >
                ...
                <>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Card className="shadow-sm">
                      <CardHeader className="py-3 border-b bg-muted/20">
                        <CardTitle className="font-bold flex items-center gap-2 text-muted-foreground">
                          <Activity className="h-4 w-4 text-emerald-500" /> VPD
                          รายวัน <VpdInfoButton />
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <ResponsiveContainer width="100%" height={200}>
          ...
          <Card className="shadow-md overflow-hidden border-t-4 border-t-teal-500">
            ...
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full font-[16px]">
                  <thead>
                    <tr className="bg-muted/50 border-b text-muted-foreground uppercase">
                      <th className="p-3 text-left font-bold border-r">
                        วันที่
                      </th>
                      {isWeatherStation ? (
                        <>
                      ...
                      return (
                        ...
                        >
                          ...
                          {isWeatherStation ? (
                            ...
                            <>
                              <td className="p-3 text-right text-lime-700 font-bold">
                                {agg.avgSoilMoisture1?.toFixed(1) || "-"}
                              </td>
                              <td className="p-3 text-right text-amber-700">
                                {agg.avgSoilTemperature1?.toFixed(1) || "-"}
                              </td>
                              <td className="p-3 text-right text-lime-700 font-bold">
                                {agg.avgSoilMoisture2?.toFixed(1) || "-"}
                              </td>
                              <td className="p-3 text-right text-amber-700">
                                {agg.avgSoilTemperature2?.toFixed(1) || "-"}
                              </td>
                            </>
                          )}
                        </tr>
